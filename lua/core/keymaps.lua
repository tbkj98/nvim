...
keymap.set('n', '<leader>fs', require('telescope.builtin').current_buffer_fuzzy_find, { desc = "Find(fuzzy) in current buffer"})
...
keymap.set("n", '<leader>df', '<cmd>Telescope dap frames<cr>', { desc = "Telescope dam frames"} )
